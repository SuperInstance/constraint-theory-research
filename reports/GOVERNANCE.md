...
The Constraint Theory project follows a **benevolent dictator governance model** with community input and transparent decision-making.
...
"SuperInstance" and "Constraint Theory" are trademarks of the SuperInstance project.
